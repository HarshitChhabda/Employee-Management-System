-- HRMS Pro Max - Database Schema (SQLite version)
-- Clean, conflict-free schema with proper constraints
-- Use this for your local SQLite Database
...
INSERT INTO departments (id, name) VALUES 
  ...
  ('dept_003', 'Sanitation / स्वच्छता'),
  ('dept_004', 'Information Technology'),
  ('dept_005', 'Human Resources')
ON CONFLICT (id) DO NOTHING;

INSERT INTO designations (id, name) VALUES 
  ('desig_001', 'Manager / प्रबंधक'),
  ('desig_002', 'Supervisor / पर्यवेक्षक'),
  ('desig_003', 'Clerk / लिपिक'),
  ('desig_004', 'Operator / ऑपरेटर'),
  ('desig_005', 'Assistant / सहायक'),
  ('desig_006', 'Peon / चपरासी')
ON CONFLICT (id) DO NOTHING;
